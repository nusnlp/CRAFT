...
def read_jsonl_data_all(file_path, start_idx, end_idx):
    input_content = open(file_path).readlines()
    all_data_list = [json.loads(i) for i in input_content]
    if end_idx is not None:
        all_data_list = all_data_list[start_idx:end_idx]
